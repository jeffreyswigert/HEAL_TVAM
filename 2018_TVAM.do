...
keep if completed_at == "2018"

cd junk
save vam_analysis_sample2018.dta, replace
...
save om1_2018.dta, replace

/*************************************************************************
OM_ID 2
**************************************************************************/

use vam_analysis_sample2018, clear
...
by therapist_id : replace wa_therapist_effect_3 = ((effect2*weight2)+(effect3*weight3)+(effect4*weight4)+(effect5*weight5)+(effect6*weight6)+(effect7*weight7)+(effect8*weight8))/7
...
by therapist_id : replace wa_therapist_effect_4 = ((effect2*weight2)+(effect3*weight3)+(effect4*weight4)+(effect5*weight5)+(effect6*weight6)+(effect7*weight7)+(effect8*weight8)+(effect9*weight9))/8
...
by therapist_id : replace wa_therapist_effect_5 = ((effect2*weight2)+(effect3*weight3)+(effect4*weight4)+(effect5*weight5)+(effect6*weight6)+(effect7*weight7)+(effect8*weight8)+(effect9*weight9))/8
...
use om1_2018.dta, clear

merge 1:1 therapist_id using om2_2018.dta, nogen
merge 1:1 therapist_id using om3_2018.dta, nogen
merge 1:1 therapist_id using om4_2018.dta, nogen
merge 1:1 therapist_id using om5_2018.dta, nogen
